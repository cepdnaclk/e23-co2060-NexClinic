...
from .views import ActivityLogListView, DoctorAppointmentAnalyticsView, ReportsView
...
urlpatterns = [
    ...
    path('appointment-analytics/', DoctorAppointmentAnalyticsView.as_view(), name='hospital-appointment-analytics'),
