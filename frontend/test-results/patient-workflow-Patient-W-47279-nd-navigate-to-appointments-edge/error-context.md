...
- Name: patient-workflow.spec.ts >> Patient Workflow >> Patient can view dashboard and navigate to appointments
- Location: e2e\patient-workflow.spec.ts:18:7
...
Locator: getByText('Test Patient')
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByText('Test Patient') with timeout 5000ms
  - waiting for getByText('Test Patient')
