...
function DetailCard({
  ...
  return (
    <div className="rounded-3xl border border-white/70 dark:border-gray-600 bg-white/90 dark:bg-gray-800 p-2 shadow-sm shadow-emerald-100/40 dark:shadow-black/20">
      ...
      />
      <p className="mt-4 text-sm font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-gray-400">
        {label}
      </p>
      <p className="mt-2 break-words text-lg font-bold text-slate-900 dark:text-gray-100">
        {value}
      </p>
    </div>
  );
...
export default function UserProfile() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.18),_transparent_28%),radial-gradient(circle_at_top_right,_rgba(20,184,166,0.14),_transparent_24%),linear-gradient(180deg,#eefbf6_0%,#f8fcfb_45%,#ffffff_100%)] pb-6">
      ...
      />
      <div
        className="absolute inset-0 bg-gradient-to-b from-white/85 via-white/78 to-white/92"
        aria-hidden="true"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-4 pt-5 sm:px-6 lg:px-8 lg:pt-8">
        <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-bold tracking-tight text-slate-900 dark:text-gray-100 sm:text-4xl">
        ...
        <div className="grid gap-5 xl:grid-cols-[1.3fr_0.7fr]">
            ...
            <div className="relative p-5 sm:p-6 lg:p-8">
              ...
              <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:gap-8">
                ...
                <div className="min-w-0 flex-1 text-center lg:text-left">
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-600 dark:text-gray-400 sm:text-base">
                    {patientEmail}
                  </p>
                  <p className="mt-1 text-sm leading-6 text-slate-600 dark:text-gray-400 sm:text-base">
                    {patientCity}
                  </p>
          ...
          <aside className="space-y-4">
            <div className="rounded-[2rem] border border-green-100 bg-white p-6 text-slate-900 dark:text-gray-100 shadow-md">
              ...
              <div className="mt-5 space-y-4">
                <div>
                  ...
                  <p className="mt-1 text-lg font-semibold text-gray-100 dark:text-gray-200">
                    {patientDob}
                  </p>
                </div>
                <div>
                  ...
                  <p className="mt-1 text-lg font-semibold leading-7 text-gray-100 dark:text-gray-200">
                    {patientAddress}
                  </p>
                </div>
                <div>
            ...
            <div className="rounded-[2rem] border border-emerald-100 bg-white p-6 shadow-lg shadow-emerald-100/40">
              ...
              <p className="mt-4 break-words text-2xl font-bold text-slate-900 dark:text-gray-100">
                {emergencyContact}
              </p>
        ...
        <section className="mt-5 rounded-[2rem] border border-green-100 bg-white p-5 shadow-[0_18px_50px_rgba(16,185,129,0.08)] sm:p-7">
          ...
          <div className="mt-5 grid grid-cols-1 gap-4 md:grid-cols-3">
            <div className="rounded-3xl bg-gradient-to-br from-emerald-50 to-white p-5 ring-1 ring-emerald-100">
              ...
              <p className="mt-3 text-base leading-7 text-slate-700 dark:text-gray-300">
                {allergies}
              </p>
            </div>
