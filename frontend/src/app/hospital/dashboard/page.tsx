...
export default function HospitalAdminDashboard() {
  ...
  useEffect(() => {
    async function fetchHospitalProfile() {
      // Try /api/hospital/profile then fallback to localStorage userInfo
      try {
          ...
          <div className="flex h-14 items-center justify-between">
            <div className="flex items-center gap-4">
              <Link href="/hospital/dashboard" className="flex items-center gap-3">
                <img src="/images/logo-main.png" alt="NexClinic" className="h-8 w-8" />
                <span className="font-bold text-lg text-gray-800">NexClinic</span>
              </Link>
              <nav className="hidden md:flex items-center gap-4 text-sm">
                <Link className="text-gray-700 hover:text-green-600" href="/hospital/dashboard">Dashboard</Link>
                <Link className="text-gray-700 hover:text-green-600" href="/hospital/doctors">Doctors</Link>
                <Link className="text-gray-700 hover:text-green-600" href="/hospital/slots">Slots</Link>
                <Link className="text-gray-700 hover:text-green-600" href="/hospital/profile">Profile</Link>
              </nav>
            </div>
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden border-t border-gray-100 py-2">
              <div className="flex flex-col px-2 py-2 gap-2">
                <Link href="/hospital/dashboard" className="block px-3 py-2 rounded text-gray-700 hover:bg-gray-50">Dashboard</Link>
                <Link href="/hospital/doctors" className="block px-3 py-2 rounded text-gray-700 hover:bg-gray-50">Doctors</Link>
                <Link href="/hospital/slots" className="block px-3 py-2 rounded text-gray-700 hover:bg-gray-50">Slots</Link>
                <Link href="/hospital/profile" className="block px-3 py-2 rounded text-gray-700 hover:bg-gray-50">Profile</Link>
                <button onClick={handleLogout} className="w-full text-left px-3 py-2 rounded text-gray-700 hover:bg-gray-50">Logout</button>
              </div>
            </div>
          )}
        </div>
        ...
        <section className="relative overflow-hidden rounded-[2rem] border border-blue-100 bg-white/95 shadow-[0_20px_60px_rgba(37,99,235,0.10)]">
          ...
          <div className="relative space-y-5 p-4 sm:space-y-6 sm:p-6 lg:p-8">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3">
              <Link href="/hospital/slots" className="group rounded-2xl border border-blue-100 bg-white/90 p-4 shadow-sm transition duration-200 hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg">
              ...
              <Link href="/hospital/doctors" className="group rounded-2xl border border-blue-100 bg-white/90 p-4 shadow-sm transition duration-200 hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg">
              ...
              <Link href="/hospital/profile" className="group rounded-2xl border border-blue-100 bg-white/90 p-4 shadow-sm transition duration-200 hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg">
