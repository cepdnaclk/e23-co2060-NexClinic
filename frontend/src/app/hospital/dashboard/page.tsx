...
export default function HospitalAdminDashboard() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      {/* Welcome Banner Card */}
      <section className="relative overflow-hidden rounded-[2rem] border border-blue-100/70 bg-white/80 p-6 sm:p-8 lg:p-10 shadow-[0_24px_80px_rgba(59,130,246,0.06)] backdrop-blur">
        <div className="absolute right-0 top-0 h-48 w-48 translate-x-1/4 -translate-y-1/4 rounded-full bg-blue-100/50 blur-3xl" aria-hidden="true" />
        ...
        <div className="relative flex flex-col lg:flex-row gap-8 items-center justify-between">
          <div className="max-w-2xl text-center lg:text-left">
            <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3.5 py-1 text-xs font-semibold tracking-[0.2em] text-blue-700">
          ...
          <div className="w-full lg:max-w-sm rounded-3xl border border-white/20 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-950 p-6 text-white shadow-xl relative overflow-hidden">
            <div className="absolute right-0 bottom-0 h-32 w-32 rounded-full bg-blue-500/10 blur-2xl" />
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-blue-300">Overview Stats</p>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-50 text-blue-600 mb-5 group-hover:bg-blue-600 group-hover:text-white transition-colors duration-200">
