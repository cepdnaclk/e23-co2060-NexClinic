        ...
        <div className="w-full py-4 px-6 shadow-md bg-white dark:bg-gray-800">
            <div className="flex items-center justify-between gap-4">
                <Link
                    ...
                    className="flex items-center gap-4 text-2xl font-bold text-gray-800 dark:text-white min-w-0"
                >
                    <img src="/images/logo-main.png" alt="NexClinic Logo" className="h-8 w-8 shrink-0" />
                    <span className="truncate">NexClinic</span>
                </Link>
                ...
                <div title="links-buttons-desktop" className="hidden md:flex items-center gap-6">
                    <div title="navigation-links" className="flex items-center gap-3 text-[16px] text-gray-800 dark:text-white">
