...
export default function UserDashboardNavbar() {
    ...
    return (
        <nav className="sticky top-0 z-50 w-full border-b border-slate-100 bg-white/80 backdrop-blur-md dark:bg-slate-900/80 dark:border-slate-800 shadow-sm">
                ...
                <div className="flex h-16 items-center justify-between">
                    ...
                    <div className="flex items-center justify-between w-full mr-8">
                        ...
                        <div className="hidden lg:flex items-center gap-1.5 text-sm font-medium">
                            <Link
                                href="/user-self/dashboard"
                                className={`relative px-4 py-2 rounded-xl transition-all duration-200 ${isActive("/user-self/dashboard")
                            ...
                            <Link
                                ...
                                className={`relative px-4 py-2 rounded-xl transition-all duration-200 ${isActive("/user-self/appointments")
                                    ? "bg-emerald-50 text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-400 font-bold"
                                    : "text-slate-650 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900"
                                    }`}
                            >
                            ...
                            <Link
                                ...
                                className={`relative px-4 py-2 rounded-xl transition-all duration-200 ${isActive("/user-self/chats")
                                    ? "bg-emerald-50 text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-400 font-bold"
                                    : "text-slate-650 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900"
                                    }`}
                            >
            ...
            {isMobileMenuOpen && (
                <div className="lg:hidden border-t border-slate-100 bg-white dark:bg-slate-900 dark:border-slate-800 animate-in fade-in slide-in-from-top-4 duration-200">
                    <div className="space-y-1.5 px-4 py-4">
                        <Link
                            href="/user-self/dashboard"
                            className={`block px-4 py-2.5 rounded-xl text-base font-medium transition-colors ${isActive("/user-self/dashboard")
                                ? "bg-emerald-50 text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-400 font-bold"
                        ...
                        <Link
                            href="/user-self/appointments"
                            className={`block px-4 py-2.5 rounded-xl text-base font-medium transition-colors ${isActive("/user-self/appointments")
                                ? "bg-emerald-50 text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-400 font-bold"
                                : "text-slate-650 hover:bg-slate-50 dark:text-slate-300 dark:hover:bg-slate-800"
                                }`}
                        >
                        ...
                        <Link
                            href="/user-self/chats"
                            className={`block px-4 py-2.5 rounded-xl text-base font-medium transition-colors ${isActive("/user-self/chats")
                                ? "bg-emerald-50 text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-400 font-bold"
                                : "text-slate-650 hover:bg-slate-50 dark:text-slate-300 dark:hover:bg-slate-800"
                                }`}
                        >
                        ...
                        <Link
                            href="/user-self/profile"
                            className={`block px-4 py-2.5 rounded-xl text-base font-medium transition-colors ${isActive("/user-self/profile")
                                ? "bg-emerald-50 text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-400 font-bold"
                                : "text-slate-650 hover:bg-slate-50 dark:text-slate-300 dark:hover:bg-slate-800"
                                }`}
                        >
