            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  disabled={loading}
                  className="block w-full rounded-xl border border-slate-200 bg-slate-50/50 pl-4 pr-10 py-2.5 text-sm text-slate-800 focus:border-emerald-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/20 transition-all disabled:opacity-50"
                />
                <button
                    type="button"
