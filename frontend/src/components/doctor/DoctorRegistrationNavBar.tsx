...
function MainNavbar() {
    return (
        <div className="flex sm:flex-wrap items-center justify-between w-screen py-4 shadow-md bg-white dark:bg-gray-800">
            ...
            <div title="links-buttons" className="flex items-center gap-6">
                <div title="navigation-links" className="flex text-[15px] gap-5">
                ...
                <div title="log-sign-buttons" className="flex gap-3 ml-">
                    <GreenButton>
                        <Link href = "/register">I'm not a Doctor</Link>
                    </GreenButton>
                </div>
            </div>
        </div>
