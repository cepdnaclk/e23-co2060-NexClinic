        ...
        <nav className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white/50 dark:border-white/10 dark:bg-slate-950/50 backdrop-blur-md shadow-sm">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                    ...
                    {/* Desktop Right Panel (Non-Doctor link) */}
                    <div className="hidden md:flex items-center gap-4 shrink-0">
                        <GreenButton>
                            <Link href="/login" onClick={closeMobileMenu}>Are you not a Doctor? Click here</Link>
                        </GreenButton>
                    </div>
                    ...
                    <div className="space-y-1.5 px-4 py-4">
                        ...
                        <div className="pt-2">
                            <GreenButton className="w-full">
                                <Link href="/login" onClick={closeMobileMenu} className="block w-full text-center">Are you not a Doctor? Click here</Link>
                            </GreenButton>
                        </div>
                    </div>
                </div>
...
export default DoctorLoginNavBar;