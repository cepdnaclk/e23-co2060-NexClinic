    ...
    <div className="w-full py-4 px-6 shadow-md bg-white dark:bg-gray-800">
      <div className="flex items-center justify-between gap-4">
        ...
        >
          <div
            ...
            className="flex items-center gap-5 text-[15px] text-gray-800 dark:text-white"
          >
            <Link href="/doctors" onClick={closeMobileMenu} className="hover:underline underline-offset-2">
              Find Doctor
            </Link>
      ...
      >
        <div title="navigation-links-mobile" className="flex flex-col gap-2 text-gray-800 dark:text-white">
          <Link href="/doctors" onClick={closeMobileMenu} className="hover:underline underline-offset-2">Find Doctor</Link>
